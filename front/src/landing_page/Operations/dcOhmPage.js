...
import { OhmForm } from '../../components/dcOhmForm';

const OhmPage = () => {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-800 mb-2">Ohm's Law Calculator</h1>
      <p className="text-gray-600 mb-6">Calculate current in a DC circuit using Ohm's Law.</p>
